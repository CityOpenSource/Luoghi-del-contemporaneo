...
?>
<!-- Full screen modal -->
    <div class="modal fade" id="modalFullScreen" tabindex="-1" aria-labelledby="modalFullScreenLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <iframe src="https://luoghidelcontemporaneo.mappi-na.it/slider/" style="height:100vh;width:100vw;z-index:500;"></iframe>
        ...
        while ( have_posts() ) :
            ...
            <div class="it-hero-wrapper">
                <div class="img-responsive-wrapper">
                    ...
                    <button type="button" data-bs-toggle="modal" data-bs-target="#modalFullScreen"><img src="<?php echo get_stylesheet_directory_uri();?>/svg/slideshow.svg" alt="Apre lo slideshow delle immagini" /></button> 
                    </div>
                </div>
            </div>
